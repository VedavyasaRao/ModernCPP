...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/auto.html){:target="_blank"}.
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/char16t-and-char32t.html){:target="_blank"}.
### constexpr
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/constexpr.html){:target="_blank"}.
### decltype
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/lambda.html){:target="_blank"}.
### list initialization
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/list-initialization.html){:target="_blank"}.
### long long
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/move-semantics.html){:target="_blank"}.
### noexcept
noexcept specifier determines whether a function could throw exceptions.  
More details can be found [here](https://modcpp11.blogspot.com/2023/09/noexcept.html){:target="_blank"}.
### nullptr
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/range-based-for-loop.html){:target="_blank"}.
### raw string
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/raw-string-literal.html){:target="_blank"}.
### rvalue reference
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/variadic-templates.html){:target="_blank"}.
## Library Features ##
...
More details can be found [here](https://modcpp11.blogspot.com/2023/11/string.html){:target="_blank"}.
### chrono library
...
More details can be found [here](https://modcpp11.blogspot.com/2023/10/chrono-library.html){:target="_blank"}.
### concurrency
C++11 introduces a new memory model and the concurrency library to support multi threaded peogramming.  
More details can be found [here](https://modcpp11.blogspot.com/2023/10/concurrency-quick-tour-with-examples.html){:target="_blank"}.
### exceptions
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/exception.html){:target="_blank"}.
### io stream
...
More details can be found [here](https://modcpp11.blogspot.com/2023/11/iostream-classes-quick-tour-with.html){:target="_blank"}.
### localization
...
More details can be found [here](https://modcpp11.blogspot.com/2023/11/internationalization-quick-tour-with.html){:target="_blank"}.
### numeric limits
...
More details can be found [here](https://modcpp11.blogspot.com/2023/10/numeric-limits.html){:target="_blank"}.
### ratio library
...
More details can be found [here](https://modcpp11.blogspot.com/2023/10/ratio.html){:target="_blank"}.
### regular expressions
...
More details can be found [here](https://modcpp11.blogspot.com/2023/11/regular-expression-quick-tour-with_6.html){:target="_blank"}.
### smart pointer
...
More details can be found [here](https://modcpp11.blogspot.com/2023/09/smartpointer.html){:target="_blank"}.
### type traits
...
More details can be found [here](https://modcpp11.blogspot.com/2024/02/type-traits.html){:target="_blank"}.
## Algorithms
...
More details can be found [here](https://modcpp11.blogspot.com/2023/12/algorithms-binary-search.html){:target="_blank"}.
### Heap
...
More details can be found [here](https://modcpp11.blogspot.com/2023/12/algorithms-heap.html){:target="_blank"}.
### Lexicographical
...
More details can be found [here](https://modcpp11.blogspot.com/2023/12/algorithms-numerics.html){:target="_blank"}.
### Merge
...
More details can be found [here](https://modcpp11.blogspot.com/2023/12/algorithms-search-and-merge.html){:target="_blank"}.
### Min/Max
...
More details can be found [here](https://modcpp11.blogspot.com/2023/12/algorithms-minmax.html){:target="_blank"}.
### Modifying
...
More details can be found [here](https://modcpp11.blogspot.com/2023/11/algorithms-modifying.html){:target="_blank"}.
### Non modifying
...
More details can be found [here](https://modcpp11.blogspot.com/2023/11/algorithmsnon-modifying.html){:target="_blank"}.
### Numerical
...
More details can be found [here](https://modcpp11.blogspot.com/2023/12/algorithms-numerical.html){:target="_blank"}.
### Partitions
...
More details can be found [here](https://modcpp11.blogspot.com/2023/12/algorithms-partitions_18.html){:target="_blank"}.
### Sort
...
More details can be found [here](https://modcpp11.blogspot.com/2023/12/algorithms-partitions.html){:target="_blank"}.
